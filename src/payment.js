...
function displayAddress(address) {
  document.querySelector(".first").textContent = "Name : "+address[0].firstName;
  document.querySelector(".last").textContent = address[0].lastName;
  document.querySelector(".street").textContent = "Street : "+address[0].street;
  ...
  document.querySelector(".mobile").textContent = "Mobile No : "+address[0].mobile;
}
